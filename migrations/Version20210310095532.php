 ...
 */
final class Version20210310095532 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE cooking_history ADD recipe_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE evaluation ADD recipe_id INT DEFAULT NULL');
        ...
        $this->addSql('ALTER TABLE recipe ADD source_id INT DEFAULT NULL, ADD course_type_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE recipe DROP source_id, DROP course_type_id');
    }
}
